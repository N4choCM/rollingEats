            ...
            <div className="carousel-inner">
              <div className="carousel-item active">
                ...
                <div className="carousel-caption d-none d-md-block text-bg-custom">
                  ...
                  <p>Prueba nuestra selección de hamburguesas gourmet.</p>
                </div>
              </div>
              <div className="carousel-item">
                ...
                <div className="carousel-caption d-none d-md-block text-bg-custom">
                  ...
                  <p>
                    Nuestras pizzas están hechas en estilo napoilitano y con
                    mucho amor.
                  </p>
                </div>
              </div>
              <div className="carousel-item">
                ...
                <div className="carousel-caption d-none d-md-block text-bg-custom">
                  <h5>¡Ándale!</h5>
                  <p>
                    La comida mexicana es una explosión de sabores, ¡y más si es
                    de Rolling Eats!.
                  </p>
                </div>
              </div>
          ...
          <div className="container">
            <div className="row pt-5 w-100 mb-4">
              <div className="col-12  ">
                ...
                <p className="texto">
                  Rolling Eats ofrece menús en línea para todos los gustos,
                  desde opciones vegetarianas hasta comida gourmet y para dietas
                  específicas. La información detallada sobre ingredientes y
                  valores nutricionales ayuda a tomar decisiones informadas. La
                  compra en línea es cómoda y práctica, ideal para personas con
